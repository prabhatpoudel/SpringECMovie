package com.prabhat.movie.domain;
...
/*	@JoinTable
	(
		      ...
		      inverseJoinColumns={ @JoinColumn(name="pic_id", referencedColumnName="pic_id", unique=true) }
		  )
...
//		this.picture=pic;
	...
	public String toString() {
		return "Artist [Id=" + Id + ", name=" + name + ", DOB=" + DOB + ", POB=" + POB + ", biography=" + biography
				+ ", picture=" + picture + ", movies=" + movies + "]";
	}
