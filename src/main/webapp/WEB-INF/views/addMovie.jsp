...
<body>
	...
	<c:if test="${not empty movieform.title}">
		<spring:url value="../edit/${movieform.id }" var="url" />
	</c:if>

	<h1>Add Movie</h1>
	<form:form method="post" modelAttribute="movieform" action="${url}">
		<table>
			<tr>
				<td>Title</td>
		...
		<table>
			<c:choose>
				<c:when test="${empty movieform.artist }">
        ...
        var1 is NOT empty or null.
        					<c:forEach items="movieform.artist" var="artist"
						varStatus="status">
